...
template<>
FAttrBasedQuadricErrord TMultiTask2MeshSimplifier<FAttrBasedQuadricErrord>::AssembleEdgeQuadric(const FDynamicMesh3::FEdge& edge) const
{
...
template <>
void TMultiTask2MeshSimplifier<FQuadricErrord>::UpdateNeighbours(const FDynamicMesh3::FEdgeCollapseInfo& collapseInfo)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::UpdateNeighbours(const FDynamicMesh3::FEdgeCollapseInfo& collapseInfo)
{
	double EdgeWeight = this->SeamEdgeWeight;
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::SimplifyToMinimalPlanar(double CoplanarAngleTolDeg)
{
